...
@Component({
  selector: 'app-notification-circle-graph',
  templateUrl: './notification-circle-graph.component.html',
  styleUrls: ['./notification-circle-graph.component.css'],
  encapsulation: ViewEncapsulation.None
})
export class NotificationCircleGraphComponent implements OnInit {
  ...
  public getNotificationTaskEffort() : void{
    this.route.params.switchMap((params: Params) => this.taskService.getNotificationTasksEffortStatus(params['id'])).subscribe(
      data => {
